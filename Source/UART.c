...
// Output: none
// Variable format 1-10 digits with no space before or after
void UART_Out_Dec(int32_t n){
// Xet bit dau
	if((n & 0x80000000) == 0){	// So nguyen duong
...
void UART_OutFloat(float n){
	int32_t IPart = (int32_t) n;
	int32_t FPart = (int32_t)(n*1000) - IPart*1000;
	
	if((IPart == 0)&&(FPart < 0)) UART_OutChar('-');
	if(FPart < 0) FPart *= -1;
...
void UART_OutFloat2(float n){
	int32_t IPart = (int32_t) n;
	int32_t FPart = (int32_t)(n*100) - IPart*100;
